...
<body>
    <div id="app">
        <nav class="navbar fixed-top navbar-expand-md navbar-dark">
            <a class="navbar-brand text-white font-weight-bold logo" href="/">Drym's Hotel<div></div></a>
            ...
            <div class="collapse navbar-collapse" id="navbarHome">
                <ul class="navbar-nav ml-auto text-uppercase font-weight-bold">
                    ...
                    <li><a href="/book/create" class="nav-link text-white btn-cta" data-toggle="modal" data-target="#book-now-modal">Book Now</a></li>
                </ul>
            </div>
        </nav>
