...
<body>
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                @if (Auth::check())
                <a href="javascript:void(0)" class="sidebar-toggle-btn" data-sidebarstatus="open"><i
                        class="fas nav-toggle fa-chevron-left"></i></a>
                @endif
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                        <li class="nav-item">
                            <a class="nav-link" href="#" role="button"><i class="fas fa-bell"></i></a>
                        </li>
