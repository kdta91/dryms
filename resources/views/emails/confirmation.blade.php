<div style="width:500px; border:1px solid #00000045; border-top: 0;">
    ...
    <div style="padding: 18px 18px 0 18px;">
        ...
        <p>
            <span>Check In: </span> {{ $details['date_in'] }} <br>
            <span>Check Out: </span> {{ $details['date_out'] }} <br>
        ...
        <p>
            Please pay the amount of &#x20B1;{{ $details['total_payment'] }} at WHERE TO PAY and send an image of the receipt at info@drymslistings.com.
        </p>
    ...
    <div style="padding: 18px; text-align: center;">
        <div style="border-top: 1px solid #00000045; padding-top: 18px;">info@drymslistings.com | (035) 420 - 0000</div>
    </div>
